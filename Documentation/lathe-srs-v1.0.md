# Lathe — Software Requirements Specification (**v1.0 — ARCHIVED SNAPSHOT**)

> **📁 Archived — do not edit.** This is the frozen v1.0 snapshot of the SRS
> that described the as-built pilot (schema through migration 0007, insights/
> folder, static `data/catalog.ts`). Kept for history.
>
> The **current living SRS is `lathe-srs.md`** (v2.0 — self-serve dashboard).

**Version:** 1.0 — as-built pilot · **Last updated:** 2026-09-06 (frozen)
**Supersedes:** `exhibly-srs.md.docx` · **Superseded by:** `lathe-srs.md` (v2.0)
