# Lathe — Product Requirements Document (**v1.0 — ARCHIVED SNAPSHOT**)

> **📁 Archived — do not edit.** This is the frozen v1.0 snapshot of the PRD
> that described the as-built pilot (event + insights + kiosk with content in
> code). Kept for history so anyone reading the codebase can trace how the
> product evolved.
>
> The **current living PRD is `lathe-prd.md`** (v2.0 — self-serve dashboard,
> content in DB). Its Changelog section explains what changed between v1.0
> and v2.0.
...
**Status:** Superseded by v2.0 on the merge of PR #19 (self-serve dashboard)
**Last updated:** 2026-09-06 (frozen)
