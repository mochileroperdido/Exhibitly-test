# Lathe — UI Design Document (**v1.0 — ARCHIVED SNAPSHOT**)

> **📁 Archived — do not edit.** This is the frozen v1.0 snapshot of the UI
> design that described the as-built pilot (top-bar dashboard nav, one dark/
> light theme, no per-tenant brand). Kept for history.
>
> The **current living UI Design is `lathe-ui-design.md`** (v2.0 —
> collapsible sidebar, self-serve modules, per-tenant brand accent).

**Version:** 1.0 — as-built · **Last updated:** 2026-09-06 (frozen)
**Supersedes:** `exhibly-ui-design-document.md.docx` · **Superseded by:** `lathe-ui-design.md` (v2.0)
